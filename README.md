...
With this configuration, the Review Agent AI exposes `OpenAI/gpt-5.4-mini`, `OpenAI/gpt-4.1`,
`LangChain/OpenAI/gpt-5.4-mini`, `LangChain/OpenAI/gpt-4.1`, and `LangChain/MoonShot/moonshot-v1-8k`.
