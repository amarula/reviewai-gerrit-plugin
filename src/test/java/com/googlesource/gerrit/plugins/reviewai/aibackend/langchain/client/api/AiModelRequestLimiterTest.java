...
public class AiModelRequestLimiterTest {
  ...
  @Test
  public void limitsConcurrentRequestsUnderFanOut() throws Exception {
    Configuration config = mock(Configuration.class);
    when(config.getAiMaxConcurrentRequests()).thenReturn(3);
    int requestCount = 12;
    CountDownLatch firstBatchEntered = new CountDownLatch(3);
