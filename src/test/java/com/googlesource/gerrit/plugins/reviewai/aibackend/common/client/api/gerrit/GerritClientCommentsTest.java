...
public class GerritClientCommentsTest {
  ...
  private static final String TRIVIAL_REPLIES_RESOURCE =
      "__files/gerritImplicitTrivialReplyComments.json";
  ...
  @Test
  public void predefinedTrivialRepliesToAssistantAreIgnored() throws Exception {
    comments = readComments(TRIVIAL_REPLIES_RESOURCE);
    when(commentsRequest.get()).thenReturn(comments);
