...
import com.googlesource.gerrit.plugins.reviewai.aibackend.common.client.prompt.agents.level0.monoagent.AiPromptReview;
...
public class AiPromptFactoryTest {
  ...
  public void patchsetAgentPromptsAreLoadedFromResource() {
    ...
    Map<String, Object> prompts =
        AiPrompt.getJsonPromptValues("agents/level1/patchset-agent/prompts");
