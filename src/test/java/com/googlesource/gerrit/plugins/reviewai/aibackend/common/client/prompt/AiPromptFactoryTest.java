...
public class AiPromptFactoryTest {
  ...
  public void routedReviewAgentInstructionsAreLoadedIntoReviewPromptFields() {
    ...
    Map<String, Object> prompts = AiPrompt.getJsonPromptValues("promptsOpenAiReviewRoutedRequests");
  ...
  public void reviewAgentRouterPromptsAreLoadedFromResource() {
    ...
    Map<String, Object> prompts = AiPrompt.getJsonPromptValues("promptsOpenAiReviewAgentRouter");
