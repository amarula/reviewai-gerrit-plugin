...
public class AiPromptSuggest extends AiPromptReview {
  ...
  public static String DEFAULT_AI_SUGGEST_MESSAGE_PATCHSET;
  public static String DEFAULT_AI_SUGGEST_MESSAGE_COMMIT_MESSAGE;
  ...
  public String getDefaultAiAssistantInstructions() {
    ...
    return joinWithDoubleNewLine(
        List.of(
            ...
            buildSection(DEFAULT_AI_SUGGEST_SECTION_TITLE_TASK, taskInstructions),
  ...
  public String getDefaultAiThreadReviewMessage(String patchSet) {
    if (changeSetData.getReviewAssistantStage() == ReviewAssistantStage.REVIEW_COMMIT_MESSAGE) {
      return String.format(DEFAULT_AI_SUGGEST_MESSAGE_COMMIT_MESSAGE, patchSet);
    }
    return String.format(
        DEFAULT_AI_SUGGEST_MESSAGE_PATCHSET,
        filterPatchWithoutCommitMessage(change, patchSet));
  }
}
