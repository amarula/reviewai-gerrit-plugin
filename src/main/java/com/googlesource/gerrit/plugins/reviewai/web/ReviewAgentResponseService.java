...
import com.googlesource.gerrit.plugins.reviewai.aibackend.common.client.messages.ReviewAgentMessageSanitizer;
...
class ReviewAgentResponseService {
  ...
  private ReviewAgentCommandContext parseReviewAgentCommand(
    ...
    message = ReviewAgentMessageSanitizer.removeLegacyRequestMarker(message);
    GerritChange change =
        new GerritChange(
