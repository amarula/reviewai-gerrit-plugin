...
package com.googlesource.gerrit.plugins.reviewai.aibackend.common.client.prompt.agents.level0.monoagent;
...
public class AiPromptReview extends AiPromptBase implements IAiPrompt {
  ...
  public AiPromptReview(
    ...
    loadDefaultPrompts("agents/level0/mono-agent/prompts");
